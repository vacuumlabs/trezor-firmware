...
class TxBuilderStateMachine:
    ...
    STATE_MINTING_ASSET_GROUPS = const(23)
    STATE_MINTING_TOKENS = const(24)
    STATE_MINTING_FINISHED = const(25)
    STATE_END = const(26)
    ...
    ACTION_MINTING_START = const(132)
    ACTION_MINTING_ASSET_GROUP_ADD = const(133)
    ACTION_MINTING_TOKEN_ADD = const(134)
    ACTION_MINTING_TOKENS_FINISH = const(135)
    ACTION_MINTING_FINISH = const(136)
    ACTION_FINISH = const(137)
    ...
    VALID_TRANSITIONS: dict[int, dict[int, int]] = {
        ...
        STATE_FEE_FINISHED: {
            ...
            ACTION_MINTING_START: STATE_MINTING_ASSET_GROUPS,
            ACTION_FINISH: STATE_END,
        },
        STATE_TTL_FINISHED: {
            ACTION_CERTIFICATES_START: STATE_CERTIFICATES,
        ...
        STATE_VALIDITIY_INTERVAL_START_FINISHED: {
            ACTION_FINISH: STATE_END,
            ACTION_MINTING_START: STATE_MINTING_ASSET_GROUPS,
        },
        STATE_MINTING_ASSET_GROUPS: {
            ACTION_MINTING_ASSET_GROUP_ADD: STATE_MINTING_TOKENS,
            ACTION_MINTING_FINISH: STATE_MINTING_FINISHED,
        },
        STATE_MINTING_TOKENS: {
            ACTION_MINTING_TOKEN_ADD: STATE_MINTING_TOKENS,
            ACTION_MINTING_TOKENS_FINISH: STATE_MINTING_ASSET_GROUPS,
        },
        STATE_MINTING_FINISHED: {ACTION_FINISH: STATE_END},
        STATE_END: {},
    }
